...
//part two
echo "<h4>" . "2. Challenge: Coin Toss, continued" . "</h4>";
...
echo "Beginning the coin flipping, looking for 3 heads in a row..." . "<br><br><br>";

echo "Flipped 3 heads in a row, in \$coinCt flips.";
